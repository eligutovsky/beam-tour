...
public class FlattenFunction {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FlattenFunction.class);
    ...
    public static void main(String[] args) {
        ...
        // The applyTransform() converts [wordsStartingWithA] and [wordsStartingWithB]
        // to [output]
    ...
    // The applyTransform two PCollection data types are the same combines and
    // returns one PCollection
