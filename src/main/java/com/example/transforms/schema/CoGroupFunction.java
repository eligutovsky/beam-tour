...
public class CoGroupFunction {
    private static final Logger LOG = LoggerFactory.getLogger(CoGroupFunction.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<Row> coGroupPCollection = PCollectionTuple.of("user", userRows).and("game", gameRows)
