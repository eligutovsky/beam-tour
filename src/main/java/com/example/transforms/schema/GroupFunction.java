...
public class GroupFunction {
    private static final Logger LOG = LoggerFactory.getLogger(GroupFunction.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> pCollection = input
                ...
                .setSchema(type,
                        TypeDescriptor.of(Object.class), row -> {
                            ...
                            return Row.withSchema(type)
                                    .addValues(user.userId, user.userName, user.game.score, user.game.gameId,
                                            user.game.date)
                                    .build();
                        },
                ...
                .apply(MapElements.into(TypeDescriptor.of(String.class))
                        .via(row -> row.getRow(0).getValue(0) + " : " + row.getRow(1).getValue(0)));
