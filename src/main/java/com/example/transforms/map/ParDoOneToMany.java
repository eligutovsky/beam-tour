...
public class ParDoOneToMany {

    private static final Logger LOG = LoggerFactory.getLogger(ParDoOneToMany.class);
    ...
    public static void main(String[] args) {
        ...
        // List of elements
        PCollection<String> input = pipeline.apply(Create.of("Hello Beam", "It is awesome"));
    ...
    // The applyTransform() divides a sentence into an array of words and outputs
    // each word
