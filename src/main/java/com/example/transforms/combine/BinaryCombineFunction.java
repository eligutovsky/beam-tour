...
public class BinaryCombineFunction {

    private static final Logger LOG = LoggerFactory.getLogger(BinaryCombineFunction.class);

    public static void main(String[] args) {
        PipelineOptions options = PipelineOptionsFactory.fromArgs(args).create();
        Pipeline pipeline = Pipeline.create(options);

        PCollection<BigInteger> input = pipeline.apply(
                Create.of(
