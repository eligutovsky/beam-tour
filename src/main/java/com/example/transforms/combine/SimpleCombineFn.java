...
public class SimpleCombineFn {

    private static final Logger LOG = LoggerFactory.getLogger(SimpleCombineFn.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<String> inputStrings = pipeline
                .apply(Create.of("quick", "brown", "fox", "jumps", "over", "the", "lazy", "dog"));
        PCollection<String> concatenated = inputStrings.apply(Combine.globally(new ConcatenateStrings()));

        concatenated.apply(ParDo.of(new LogOutput<>()));
