...
public class SideInputFn {

    private static final Logger LOG = LoggerFactory.getLogger(SideInputFn.class);
    ...
    public static void main(String[] args) {
        ...
        // List of elements
        PCollection<KV<String, String>> citiesToCountries = pipeline.apply("Cities and Countries",
                Create.of(
                        KV.of("Beijing", "China"),
        ...
        PCollectionView<Map<String, String>> citiesToCountriesView = createView(citiesToCountries);

        PCollection<Person> persons = pipeline.apply("Persons",
                Create.of(
        ...
        // The applyTransform() converts [persons] and [citiesToCountriesView] to
        // [output]
        ...
        // .apply("FormatTime", ParDo.of(new DoFn<KV<String, KV<Person, Integer>>,
        // Person>() {
        // @ProcessElement
        ...
        // }
        // c.output(new Person(person.name, person.city, String.format("%d:%d", time,
        // now.getMinute())));
        // }
        // }));
