...
public class challenge3 {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(challenge3.class);
    ...
    public static void main(String[] args) {
        ...
        final PTransform<PCollection<KV<String, Integer>>, PCollection<Iterable<KV<String, Integer>>>> sample = Sample
                .fixedSizeGlobally(100);
