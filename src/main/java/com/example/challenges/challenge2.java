...
public class challenge2 {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(challenge2.class);
    ...
    public static void main(String[] args) {
        ...
        PCollection<KV<String, Long>> flattenPCollection = mergePCollections(newFirstPartPCollection,
                newSecondPartPCollection, allLetterLowerCase);
    ...
    static PCollection<KV<String, Long>> convertPCollectionToLowerCase(PCollection<KV<String, Long>> input) {
        return input.apply(MapElements.into(TypeDescriptors.kvs(TypeDescriptors.strings(), TypeDescriptors.longs()))
                .via((KV<String, Long> wordCount) -> KV.of(wordCount.getKey().toLowerCase(), wordCount.getValue())));
    }

    static PCollection<KV<String, Long>> mergePCollections(PCollection<KV<String, Long>> input1,
            PCollection<KV<String, Long>> input2, PCollection<KV<String, Long>> input3) {
    ...
    static PCollectionList<String> partitionPCollectionByCase(PCollection<String> input) {
        return input.apply(Partition.of(3, (PartitionFn<String>) (word, numPartitions) -> {
