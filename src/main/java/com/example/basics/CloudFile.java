...
public class CloudFile {
        ...
        private static final Logger LOG = LoggerFactory.getLogger(CloudFile.class);
        ...
        public static void main(String[] args) {
                ...
                // Concept #1. Read text file content line by line. resulting PCollection
                // contains elements, where each element
                ...
                final PTransform<PCollection<String>, PCollection<Iterable<String>>> sample = Sample
                ...
                sampleLines.apply(TextIO.write().to("sample-words"));
